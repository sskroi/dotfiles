...
mod = "mod4"
terminal = "alacritty"
fileManager = f"{terminal} -e yazi"

keys = [
    Key([mod], "q", lazy.spawn(terminal), desc="Launch terminal"),
    Key([mod], "r", lazy.spawncmd(), desc="Spawn a command using a prompt widget"),
    Key([mod], "y", lazy.spawn(fileManager), desc="Launch file manager"),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Systray(),
                widget.KeyboardLayout(configured_keyboards=['us','ru'], option='caps:swapescape'),
                widget.Clock(format="&#8239;%d-%m-%Y &#8239;%H:%M"),
            ],
            24,
            # border_width=[2, 0, 2, 0],  # Draw top and bottom borders
            # border_color=["ff00ff", "000000", "ff00ff", "000000"]  # Borders are magenta
        ), wallpaper="~/Pictures/Ayanami/Ayanami3.png", wallpaper_mode="stretch"
